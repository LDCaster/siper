                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped" id="table-2">
                                    ...
                                    <tbody>
                                    <?php $no = 1; ?>
                                    <?php foreach ($detailtugas as $penatausahaan_arsip) : ?>
                                            <tr>
                                                <td><?= $no++ ?></td>
                                                <td><?= $penatausahaan_arsip['nama_bidang']; ?></td>
                                                <td><?= $penatausahaan_arsip['sasaran']; ?> , <?= $penatausahaan_arsip['indikator']; ?></td>
                                                <td><?= $penatausahaan_arsip['target']; ?></td>

                                            <td>
                                                
                                                    <a href="<?= base_url('/penatausahaan_arsip/destroyDetailTugas/' . $penatausahaan_arsip['id']); ?>" class="btn btn-danger mr-2" title="Hapus"> <i class="fa fa-trash"></i>
                                                    </a>
                                            </td>  
