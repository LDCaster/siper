                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <?php if (session()->has('success')) : ?>
                            ...
                            <form action="<?= base_url('penatausahaan_arsip/storeDetail'); ?>" method="post">
                                <?= csrf_field(); ?>
                                <input type="hidden" name="id_penatausahaan" value="<?= $penatausahaan_arsip['id']; ?>"> <!-- Menggunakan ID anggaran dari variabel $anggaran -->
