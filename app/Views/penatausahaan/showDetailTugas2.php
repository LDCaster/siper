            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <a href="<?= base_url('penatausahaan/createDetailTugas2/' . $id_anggota); ?>"
                   ...
                   <input type="hidden" name="id_penatausahaan" value="<?= $penatausahaan['id_penatausahaan']; ?>">
                                                    ...
                                                    <a href="<?= base_url('/penatausahaan/destroydetailtugas2/' . $penatausahaan['id']);  ?>" class="btn btn-danger mr-2" title="Hapus"> <i class="fa fa-trash"></i>
                                                    </a>
                                            </td>  
