                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <?php if (session()->has('success')) : ?>
                            ...
                            <form action="<?= base_url('penatausahaan/storeDetailTugas2'); ?>" method="post">
                                <?= csrf_field(); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <a href="<?= base_url('penatausahaan/showDetailTugas2/'. $detail_penatausahaan['id'] ); ?>" class="btn btn-secondary">Kembali</a>
                                </div>
                            </form>
