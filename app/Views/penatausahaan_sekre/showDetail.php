                                ...
                                <table class="table table-striped" id="table-2">
                                    ...
                                    <?php foreach ($detail as $penatausahaan) : ?>
                                            <tr>
                                                ...
                                                <a href="<?= base_url('penatausahaan_sekre/createDetailTugas2/' . $penatausahaan['id']); ?>"
                                                ...
                                                <a href="<?= base_url('penatausahaan_sekre/showDetailTugas2/' . $penatausahaan['id']); ?>"
                                                    class="btn btn-sm btn-info mb-2" title="Tampil Tugas penatausahaan">
                                                    <i class="fa fa-eye"></i> Tampil Tugas utama
                                                </a>

                                                <a href="<?= base_url('penatausahaan_sekre/createDetailTugas/' . $penatausahaan['id']); ?>"
                                                    class="btn btn-sm btn-primary mb-2" title="Tambah Tugas penatausahaan">
                                                    <i class="fa fa-plus"></i> Tambah Tugas 
                                                </a>

                                                <!-- Tombol "Tampil Detail penatausahaan" -->
                                                <a href="<?= base_url('penatausahaan_sekre/showDetailTugas/' . $penatausahaan['id']); ?>"
                                                    class="btn btn-sm btn-info mb-2" title="Tampil Tugas penatausahaan">
