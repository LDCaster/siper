...
<div class="main-content">
    <section class="section">
        ...
        <div class="section-body">
            <h2 class="section-title">Form Bukti Pelaporan</h2>
                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <?php endif; ?>
                            <form action="<?= route_to('buktipelaporan/store'); ?>" method="post" enctype="multipart/form-data">
                                <?= csrf_field(); ?>
