...
<div class="main-content">
    <section class="section">
        <div class="section-header">
            <h1>Bukti Pelaporan Kearsipan</h1>
            <div class="section-header-breadcrumb">
                <div class="breadcrumb-item active"><a href="#">Dashboard</a></div>
                <div class="breadcrumb-item"><a href="#">Pelaporan</a></div>
                <div class="breadcrumb-item"><a href="#">Bukti Pelaporan Kearsipan</a></div>
                <div class="breadcrumb-item">Data</div>
            </div>
        </div>

        <div class="section-body">
            <h2 class="section-title">Bukti Pelaporan Kearsipan</h2>
            <p class="section-lead">
                Daftar Bukti Pelaporan Kearsipan
            </p>
            <style>
   .status-verifikasi {
        padding: 5px;
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4>Bukti Pelaporan Kearsipan</h4>
                        </div>
                        <div class="card-body">
                        ...
                        <a href="/buktipelaporan/createarsip" class="btn btn-primary">Tambah Bukti Pelaporan Kearsipan</a>
                         </div>
                            ...
                            <table class="table table-bordered" id="table-1">
                                    ...
                                    <tbody>
                                    <?php $no = 1; ?>
                                        <?php foreach ($bp_arsip as $dd) : ?>
                                            <?php if (isset($dd['status_data']) && $dd['status_data'] == 'KEARSIPAN') : ?>
                                            <tr>
                                            <td><?= $no++ ?></td>                                                
                                                ...
                                                <td>
                                                    <a href="/buktipelaporan/previewarsip/<?= $dd['id']; ?>" class="btn btn-info btn-sm" >Pratinjau</a>
                                                    <a href="/buktipelaporan/download/<?= $dd['id']; ?>" class="btn btn-success btn-sm">Unduh</a>
                                                    <a href="/buktipelaporan/destroyarsip/<?= $dd['id']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Apakah Anda yakin ingin menghapus data ini?')">Hapus</a>
                                                </td>
                                            </tr>
                                        <?php endif; ?>
                                        <?php endforeach; ?>
                                        <?php if (empty($bp_arsip)) : ?>
                                            <tr>
