...
<div class="main-content">
    <section class="section">
        <div class="section-header">
            <h1>Tambah Bukti Pelaporan Kearsipan</h1>
        ...
        <div class="section-body">
            <h2 class="section-title">Form Bukti Pelaporan Kearsipan</h2>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4>Form Bukti Pelaporan Kearsipan</h4>
                        </div>
                        <div class="card-body">
                            ...
                            <?php endif; ?>
                            <form action="<?= route_to('buktipelaporan/storearsip'); ?>" method="post" enctype="multipart/form-data">
                                <?= csrf_field(); ?>
                                ...
                                <input type="text" name="status_data"  value="KEARSIPAN" class="form-control"  hidden required>
