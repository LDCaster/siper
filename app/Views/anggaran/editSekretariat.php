...
<div class="main-content">
    <section class="section">
        ...
        <div class="section-body">
            <h2 class="section-title">Form Edit <?= $title; ?> Sekretariat</h2>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <form action="<?php echo base_url('anggaran/update/sekretariat/' . $anggaran['id']); ?>" method="post" enctype="multipart/form-data">
                            <?= csrf_field(); ?>
                            <div class="card-body">
                                ...
                                <div class="card-footer text-right">
                                    ...
                                    <a href="<?= base_url('anggaran/index/sekretariat'); ?>" class="btn btn-danger">Batal</a>
                                </div>
                        </form>
                    </div>
                </div>
