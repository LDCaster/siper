                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="buttons" style="margin-top: -20px;">
                                <a href="<?= route_to('perencanaan/create/rakor'); ?>" class="btn btn-primary">Tambah</a>
                                <a href="<?= route_to('cetakRakor'); ?>" class="btn btn-warning">Cetak</a>
                                <a href="<?= route_to('tampilanCetakRakor'); ?>" class="btn btn-dark">Preview</a>
                                <a href="<?= route_to('ddperencanaanrakor/indexrakor'); ?>" class="btn btn-success">Data Dukung</a>
                            </div>
                                    ...
                                    <tbody>
                                        <?php if (!empty($perencanaan)) : ?>
                                            ...
                                            <?php foreach ($perencanaan as $item) : ?>
                                                <?php if ($item['status_perencanaan'] === 'RAKORTEKBANG') : ?>
                                                    <tr>
                                                        <td><?= $no++; ?></td>
                                                        <td><?= $item['urusan']; ?></td>
