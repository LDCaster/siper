                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <?php endif; ?>
                            <form action="<?= base_url('ddperencanaanrakor/storeRakor'); ?>" method="post" enctype="multipart/form-data">
                                <?= csrf_field(); ?>
                                ...
                                <select class="form-control" id="status_file" name="status_file" Hidden readonly>
                                ...
                                <select class="form-control" id="status_tujuan" name="status_tujuan" readonly>
                                        <option value="KEARSIPAN" selected>KEARSIPAN</option>
                                    </select>
