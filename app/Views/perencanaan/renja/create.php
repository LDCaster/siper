...
<div class="main-content">
    <section class="section">
        ...
        <div class="section-body">
            <h2 class="section-title">Form Renja</h2>
            <p class="section-lead">
                Silakan isi formulir di bawah ini untuk membuat Renja.
            </p>
                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <?php endif; ?>
                            <form action="<?= route_to('perencanaan/storerenja'); ?>" method="post">
                                <?= csrf_field(); ?>
                                ...
                                <!-- pilihan Status Perencanaan default value nya renja dan readonly -->
                                <div class="form-group">
                                    <label>Status Perencanaan</label>
                                    <select class="form-control" id="status_perencanaan" name="status_perencanaan" readonly>
                                        <option value="NON RAKORTEKBANG" selected>NON RAKORTEKBANG</option>
                                    </select>
                                </div>
                                ...
                                <div class="card-footer text-right">
                                    ...
                                    <a href="<?= route_to('perencanaan/index/renja'); ?>" class="btn btn-secondary">Batal</a>
...
<script>
    $(document).ready(function() {
        // Mencegah klik pada status perencanaan
        $('#status_perencanaan').click(function(e) {
            e.preventDefault();
        });
...
<script>
    $(document).ready(function () {
        ...
        $('#subkegiatan').change(function () {
            ...
            $.ajax({
                url: '<?= base_url('perencanaan/getIndikator') ?>',
                method: 'post',
