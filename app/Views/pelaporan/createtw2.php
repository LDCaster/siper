...
<div class="main-content">
    <section class="section">
        <div class="section-header">
            <h1>Form Triwulan II </h1>
            <div class="section-header-breadcrumb">
                <div class="breadcrumb-item active"><a href="#">Dashboard</a></div>
                <div class="breadcrumb-item"><a href="#">Triwulan II</a></div>
                <div class="breadcrumb-item">Create</div>
            </div>
        </div>

        <div class="section-body">
            <h2 class="section-title">Form Tambah Triwulan II</h2>
                ...
                <div class="col-12 col-md-12 col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h4>Form Tambah Triwulan II</h4>
                        </div>
                        <div class="card-body">
                            <!-- Form untuk membuat pelaporan -->
                            <form action="<?= route_to('tw2/storetw2'); ?>" method="post">
                                <?= csrf_field(); ?>
                                ...
                                <input type="hidden" name="tw" value="TW-2">
