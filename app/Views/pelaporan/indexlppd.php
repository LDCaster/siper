...
<div class="main-content">
    <section class="section">
        ...
        <div class="section-body">
            <h2 class="section-title">Data Pelaporan LPPD</h2>
            <p class="section-lead">
                Ini merupakan data Pelaporan LPPD yang terdaftar di Dispusip.
            </p>
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4>TABEL DATA PELAPORAN LPPD</h4>
                        </div>
                        <div class="card-body">
                            <div class="buttons" style="margin-top: -20px;">
                                ...
                                <?php endif ?>
                                <a href="/pelaporanlaporanlppd" class="btn btn-success">Laporan</a>
                                <a href="/backup" class="btn btn-danger">Backup</a>
                                <a href="<?= base_url('ddpelaporanlppd'); ?>" class="btn btn-brown">Data Dukung</a>
