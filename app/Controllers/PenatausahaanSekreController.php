...
class PenatausahaanSekreController extends BaseController
{
    ...
    {
        $penatausahaans = $this->penatausahaanModel->getPenatausahaan();
        // dd($anggaran);
        ...
        return view('penatausahaan_sekre/index', $data);
    }
    ...
    public function create()
    {
        ...
        return view('penatausahaan_sekre/create', ['karyawans' => $karyawans, 'anggarans' => $anggarans, 'pohons' => $pohons, 'kinerjas' => $kinerjas]);
    }
    ...
    public function store()
    {
        ...
        if ($this->validate($validationRules)) {
            ...
            return redirect()->to('/penatausahaan_sekre');
        } else {
            // Validasi gagal, tampilkan kembali form dengan pesan error
            return view('penatausahaan_sekre/create', [
                'karyawans' => $this->karyawanModel->findAll(),
                'anggarans' => $this->anggaranModel->findAll(),
                'pohons' => $this->pohonModel->findAll(),
    ...
    public function edit($id)
    {
        ...
        return view('penatausahaan_sekre/edit', ['penatausahaan' => $penatausahaan, 'karyawans' => $karyawans, 'anggarans' => $anggarans, 'pohons' => $pohons, 'kinerjas' => $kinerjas]);
    }
    ...
    public function update($id)
    {
        ...
        if ($this->validate($validationRules)) {
            ...
            // Validasi gagal, tampilkan kembali form dengan pesan error
            return view('penatausahaan_sekre/edit', [
                'penatausahaan' => $this->penatausahaanModel->find($id),
                'karyawans' => $this->karyawanModel->findAll(),
                'anggarans' => $this->anggaranModel->findAll(),
                'pohons' => $this->pohonModel->findAll(),
    ...
    public function createDetail($id_penatausahaan)
    {
        ...
        return view('penatausahaan_sekre/createDetail', $data);
    ...
    public function showDetail($id_penatausahaan)
    {
        ...
        return view('penatausahaan_sekre/showDetail', $data);
    }
...
// Hagan Detail Tugas Tambahan Penatausahaan
    public function createDetailTugas($id_anggota)
    {
        ...
        return view('penatausahaan_sekre/createDetailTugas', $data);
    ...
    public function storeDetailTugas()
    {
        ...
        if ($detailtugaspenatausahaanModel->insert($data)) {
            ...
            // return redirect()->to('/penatausahaan_sekre');
            return redirect()->to('/penatausahaan_sekre/showDetailTugas/'.$id);
    ...
    public function showDetailTugas($id_anggota)
    {
        ...
        return view('penatausahaan_sekre/showDetailTugas', $data);
    }
...
// Hagan Detail Tugas Utama Penatausahaan
    public function createDetailTugas2($id_anggota)
    {
        ...
        return view('penatausahaan_sekre/createDetailTugas2', $data);
    ...
    public function storeDetailTugas2()
{
    ...
    if ($detailtugas2penatausahaanModel->insert($data)) {
        session()->setFlashdata('pesan', 'Data Berhasil ditambahkan!');
        return redirect()->to('/penatausahaan_sekre/showDetailTugas2/'.$id);
        // return redirect()->to('/penatausahaan_sekre');
    ...
    public function showDetailTugas2($id_anggota)
    {
        ...
        return view('penatausahaan_sekre/showDetailTugas2', $data);
    }
    ...
    public function previewCetak($id)
    {
        ...
        return view('penatausahaan_sekre/previewCetak', $data);
    }
    ...
    public function cetak($id)
    {
        ...
        $html = view('penatausahaan_sekre/cetak', $data);
    ...
    public function destroydetail($id)
    {
        ...
        return redirect()->to('penatausahaan_sekre/showDetailTugas');
    }
    ...
    public function destroydetailtugas2($id)
    {
        ...
        return redirect()->to('/penatausahaan_sekre');
        // return redirect()->to('/penatausahaan_sekre/showDetailTugas2/'.$id_p);
    }
}
